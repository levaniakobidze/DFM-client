          ...
          {notifications.length > 0 && (
            <div className="border-t border-gray-100 dark:border-gray-800">
              <Link
                ...
                className="flex items-center justify-center gap-1.5 w-full px-4 py-3 text-sm font-medium text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-colors"
              >
