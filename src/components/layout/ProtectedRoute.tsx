  ...
  if (!isLoggedIn) {
    return (
      <div className="max-w-xl mx-auto px-4 py-20 text-center">
        <div className="w-16 h-16 rounded-2xl bg-violet-50 text-violet-600 flex items-center justify-center text-3xl mx-auto mb-5">
          🔒
        </div>
        <h2 className="text-xl font-bold text-gray-900 mb-2">{t.protected.title}</h2>
        <p className="text-gray-500 mb-7">{t.protected.desc}</p>
