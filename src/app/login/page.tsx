    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 bg-gray-50 dark:bg-gray-950">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mt-4 mb-1">{t.auth.loginTitle}</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">{t.auth.loginSubtitle}</p>
        </div>
